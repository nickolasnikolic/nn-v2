...
<html>
  ...
  <body>
    ...
    <section id="content">
      ...
      <section id="academic">
        <article id="miad">
          <h2>miad (no degree)</h2>
          <p>content</p>
        </article>
        <article id="uwm">
          <h2>university of wisconsin-milwaukee (bfa 2004)</h2>
          <p>content</p>
        </article>
        <article id="du">
          <h2>university of denver: graduate work (mas expected 2018)</h2>
          <p>content</p>
        </article>
      </section>
      <section id="personal">
        <article>
          <h2>personal</h2>
          <p>In my professional life, I most recently served More Than Rewards' mission
            primarily as a mobile developer. In the past I've been a webmaster, support
            professional, photographer, multimedia journalist, automotive factory worker,
            even a dairy farmer. I'm oddly familiar with many things in many
            industries.</p>
        </article>
        <article>
          <h2>Open Source</h2>
